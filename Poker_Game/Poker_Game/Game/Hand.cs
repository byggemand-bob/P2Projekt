...
namespace Poker_Game.Game {
    ...
    public class Hand {
        ...
        private void ResetActions() {
            foreach(Player player in Players) player.Action = PlayerAction.None;
        }
        ...
        public bool IsFinished() {
            if(PlayersLeft() > 1) return Rounds.Count == 5;
        ...
        private List<Player> InitializePlayers(List<Player> players, int dealerButtonPosition) {
            ...
            for(int i = 0; i < initPlayers.Count; i++) {
                ...
                else if(i == (dealerButtonPosition + 2) % initPlayers.Count) initPlayers[i].IsBigBlind = true;
            }
