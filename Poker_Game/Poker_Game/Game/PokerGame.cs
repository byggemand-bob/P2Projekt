...
namespace Poker_Game.Game {
    public class PokerGame {
        ...
        public void UpdateState() {
            ...
            if(!_roundInProgress && _handInProgress) NewRound();
        }
        ...
        public void RewardWinners() {
            ...
            if(winners.Count == 1) Hand.Winner = winners[0];
            foreach(Player player in winners) player.Stack += Hand.Pot / winners.Count;
        }
        ...
        private List<Player> GetWinningPlayers(List<Player> players) {
            ...
            if(players[0].Score > players[1].Score) return new List<Player> {players[0]};
            if(players[0].Score < players[1].Score) return new List<Player> {players[1]};
        ...
        private List<Player> InitializePlayers() {
            ...
            for(int id = 0; id < Settings.NumberOfPlayers; id++) players.Add(new Player(id, Settings.StackSize));
            return players;
        }
        ...
        public void Check() {
            // Method used for coding a press of Check-button in GameForm.
        ...
        public void Raise() {
            // Method used for coding a press of Raise-button in GameForm.
        ...
        public void Fold() {
            // Method used for coding a press of Fold-button in GameForm.
